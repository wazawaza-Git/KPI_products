...
public class Mondai205 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.print("商品番号を入力してくださいーー＞");
			...
			String SQL = "Insert into " + tableName
					+ " (productNumber, productName, productPrice) values (?, ?, ?);";
